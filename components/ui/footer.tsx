...
export default function Footer() {
  return (
    <footer className="flex absolute flex-col shrink-0 w-full border-t-2 border-green-500/20 bg-gray-950 dark:border-gray-950 dark:bg-gray-50">
      <div className="container grid max-w-6xl min-h-[200px] grid-cols-12 items-center gap-4 py-6 text-sm md:gap-8 md:py-10">
        ...
        <nav className="lg:flex hidden col-span-12 flex-col gap-2 md:flex-row md:col-start-4 md:col-span-2 lg:gap-4 lg:col-start-5 lg:col-span-3 xl:col-start-6 xl:col-span-2">
          <Link
        ...
        <div className="col-span-12 lg:flex hidden flex-col gap-2 md:col-start-6 md:col-span-6 lg:col-start-1 lg:col-span-4 xl:col-start-4 xl:col-span-6 -ml-48">
          <Link className="text-gray-100 hover:underline" href="#">
            Terms & Conditions
          </Link>
          <Link className="text-gray-100 hover:underline" href="#">
            Privacy Policy
